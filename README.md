...
I build apps and take them all the way to real users. One of them is live right now: a basketball app on the App Store. I write the frontend, the backend and the database, and I do the deploys.
